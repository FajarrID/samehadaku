...
const movie = `${baseUrl}anime-movie/`;
const studio = `${baseUrl}studio/`;
const producer = `${baseUrl}producers/`;
const season = `${baseUrl}season/`;
...
module.exports.ongoingAnime = async (req, res) => {
  const params = req.query.page;
  const page =
    typeof params === "undefined" ? "" : params === "1" ? "" : `page/${params}`;
...
module.exports.animeSchedule = async (req, res) => {
  try {
...
module.exports.allGenres = async (req, res) => {
  try {
...
module.exports.showGenre = async (req, res) => {
...
module.exports.allAnimeMovie = async (req, res) => {
  const params = req.params.page;
  const page =
    typeof params === "undefined" ? "" : params === "1" ? "" : `page/${params}`;
...
module.exports.showProducer = async (req, res) => {
  const id = req.params.id;
  const params = req.params.page;
  const page =
    typeof params === "undefined" ? "" : params === "1" ? "" : `page/${params}`;
...
module.exports.showSeason = async (req, res) => {
  const id = req.params.id;
  const params = req.params.page;
  const page =
    typeof params === "undefined" ? "" : params === "1" ? "" : `page/${params}`;
