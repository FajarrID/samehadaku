...
router.get("/anime/page", allAnime);
router.get("/anime/detail", detailAnime);

router.get("/anime/eps", showEpisode);
...
router.get("/batch", detailBatch);

router.get("/movie", allAnimeMovie);
router.get("/movie/page", allAnimeMovie);
